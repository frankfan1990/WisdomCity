...
- (void)viewDidLoad {
    ...
    _previousNavigationBarBackgroundImageDefault = [[UIImage imageNamed:@"nav_bg.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 5, 10, 5)];
    _previousNavigationBarBackgroundImageLandscapePhone =[[UIImage imageNamed:@"nav_bg.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 5, 10, 5)];
    ...
    if ([[UIToolbar class] respondsToSelector:@selector(appearance)]) {
        [_toolbar setBackgroundImage:_previousNavigationBarBackgroundImageDefault forToolbarPosition:UIToolbarPositionAny barMetrics:UIBarMetricsDefault];
        [_toolbar setBackgroundImage:_previousNavigationBarBackgroundImageDefault forToolbarPosition:UIToolbarPositionAny barMetrics:UIBarMetricsLandscapePhone];
    }
    ...
    [btnback setFrame:CGRectMake(0, 0, 38.5, 23.5)];
    ...
    [btnback setBackgroundImage:[UIImage imageNamed:@"back_selected.png"] forState:UIControlStateHighlighted];
    ...
    [btnmore setFrame:CGRectMake(0, 0, 38.5, 23.5)];
    [btnmore setBackgroundImage:[UIImage imageNamed:@"f_more.png"] forState:UIControlStateNormal];
    [btnmore setBackgroundImage:[UIImage imageNamed:@"f_more_seleted.png"] forState:UIControlStateHighlighted];
    [btnmore setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    btnmore.titleLabel.font = [UIFont systemFontOfSize:13];
    [btnmore addTarget:self action:@selector(actionMore) forControlEvents:UIControlEventTouchUpInside];
    UIBarButtonItem *btnMoreitem = [[UIBarButtonItem alloc] initWithCustomView:btnmore];
    self.navigationItem.rightBarButtonItem = btnMoreitem;
    //[btnMoreitem release];
...
- (void)setNavBarAppearance:(BOOL)animated {
    ...
    if ([[UINavigationBar class] respondsToSelector:@selector(appearance)]) {
        ...
        [navBar setBackgroundImage:_previousNavigationBarBackgroundImageDefault forBarMetrics:UIBarMetricsLandscapePhone];
    }
}
...
- (void)actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex {
    ...
    }else if(actionSheet.tag == 201)
    {
        if(buttonIndex == 0)
        {
            if([_delegate respondsToSelector:@selector(photobrowserSaveinSystemPhoto)])
            {
                [_delegate photobrowserSaveinSystemPhoto];
            }
