...
extern NSString *const RZCollectionElementKindSectionHeader;
/// A supplementary view that identifies the footer for a given section.
extern NSString *const RZCollectionElementKindSectionFooter;

#pragma mark - RZCollectionViewDelegateWaterfallLayout

@class RZCollectionViewWaterfallLayout;

/**
 *  The RZCollectionViewDelegateWaterfallLayout protocol defines methods that let you coordinate with a
 *  RZCollectionViewWaterfallLayout object to implement a waterfall-based layout.
 ...
 */
@protocol RZCollectionViewDelegateWaterfallLayout <UICollectionViewDelegate>
@required
/**
...
#pragma mark - RZCollectionViewWaterfallLayout

/**
 *  The RZCollectionViewWaterfallLayout class is a concrete layout object that organizes items into waterfall-based grids 
 ...
 *  in each section. That delegate object must conform to the `RZCollectionViewDelegateWaterfallLayout` protocol.
 *
 ...
 *
 *  @note RZCollectionViewWaterfallLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
@interface RZCollectionViewWaterfallLayout : UICollectionViewLayout
