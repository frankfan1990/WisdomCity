...
//
//  Created by H.DX on 12/11/19.
//  Copyright (c) 2012 H.DX Tai. All rights reserved.
//

#import "RZCollectionViewWaterfallLayout.h"

NSString *const RZCollectionElementKindSectionHeader = @"RZCollectionElementKindSectionHeader";
NSString *const RZCollectionElementKindSectionFooter = @"RZCollectionElementKindSectionFooter";

@interface RZCollectionViewWaterfallLayout ()
/// The delegate will point to collection view's delegate automatically.
@property (nonatomic, weak) id <RZCollectionViewDelegateWaterfallLayout> delegate;
...
@implementation RZCollectionViewWaterfallLayout
...
- (void)prepareLayout {
  ...
  self.delegate = (id <RZCollectionViewDelegateWaterfallLayout> )self.collectionView.delegate;
  NSAssert([self.delegate conformsToProtocol:@protocol(RZCollectionViewDelegateWaterfallLayout)], @"UICollectionView's delegate should conform to RZCollectionViewDelegateWaterfallLayout protocol");
  ...
  for (NSInteger section = 0; section < numberOfSections; ++section) {
    ...
    if (headerHeight >0) {
      attributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:RZCollectionElementKindSectionHeader withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
    ...
    if (footerHeight > 0) {
      attributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:RZCollectionElementKindSectionFooter withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
