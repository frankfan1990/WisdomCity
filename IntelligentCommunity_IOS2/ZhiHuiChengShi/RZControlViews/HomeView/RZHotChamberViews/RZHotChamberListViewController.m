...
-(void)createTableView
{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 12+35+10, self.view.frame.size.width, self.view.frame.size.height-130) style:UITableViewStylePlain];
